...
assert.match(html, /const baseRadius = Math\.max\(3, minDim \* \(0\.012 \+ apertureScale \* 0\.009\) \* focusLift\)/, "Default bokeh radius stays in a restrained photographic range");
